...
copy "install.bat" "C:\Program Files\hetao\bin\install.bat" /Y
copy "uninstall.bat" "C:\Program Files\hetao\bin\uninstall.bat" /Y
copy "bin\mfc90d.dll" "C:\Program Files\hetao\bin\mfc90d.dll" /Y
copy "bin\msvcr90d.dll" "C:\Program Files\hetao\bin\msvcr90d.dll" /Y
